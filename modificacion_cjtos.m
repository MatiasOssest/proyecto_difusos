...
%% Cambio conjuntos difusos
%%Condicion Inicial P=650

%Mejora para metodo alturas
% ng = [-1.0 -1.0 -0.7 -0.55];
% nm = [-0.8 -0.65 -0.35 -0.1];
% np = [-0.4 -0.3 -0.2 -0.1];
% ni = [-0.2 -0.1 0.0 0.0];
% ce = [-0.25 0 0 0.25];
% pi = [0.0 0.0 0.1 0.2];
% pp = [0.1 0.2 0.3 0.4];
% pm = [0.1 0.35 0.65 0.8];
% pg = [0.55 0.7 1.0 1.0];

Cjtos = [ng;nm;np;ni;ce;pi;pp;pm;pg];
plot_conjuntos(Cjtos,22)

%Centro de Gravedad
[PresionCG650,CalorCG650, ErrorCG650, TasaErrorCG650,...
    rulesCG650, reglas_acumCG650] =  Controlador2(650,"CG",30);

%MoM 
[PresionMoM650,CalorMoM650, ErrorMoM650, TasaErrorMoM650,...
    rulesMoM650, reglas_acumMoM650] =  Controlador2(650,"MoM",30);

%Alturas
[Presionh650,Calorh650, Errorh650, TasaErrorh650,...
    rulesh650, reglas_acumh650] =  Controlador2(650,"h",30);
...
graficar_variables(PresionCG650, PresionMoM650, Presionh650, ...
    "Evolución de la Presión con P(0) = 650", "Presión",7)
...
[PresionCG730,CalorCG730, ErrorCG730, TasaErrorCG730,...
    rulesCG730, reglas_acumCG730] =  Controlador2(730,"CG",30);

%MoM 
[PresionMoM730,CalorMoM730, ErrorMoM730, TasaErrorMoM730,...
    rulesMoM730, reglas_acumMoM730] =  Controlador2(730,"MoM",30);

%Alturas
[Presionh730,Calorh730, Errorh730, TasaErrorh730,...
    rulesh730, reglas_acumh730] =  Controlador2(730,"h",30);
...
graficar_variables(PresionCG730, PresionMoM730, Presionh730, ...
    "Evolución de la Presión con P(0) = 730", "Presión",14)
...
[PresionCG840,CalorCG840, ErrorCG840, TasaErrorCG840,...
    rulesCG840, reglas_acumCG840] =  Controlador2(840,"CG",30);

%MoM 
[PresionMoM840,CalorMoM840, ErrorMoM840, TasaErrorMoM840,...
    rulesMoM840, reglas_acumMoM840] =  Controlador2(840,"MoM",30);

%Alturas
[Presionh840,Calorh840, Errorh840, TasaErrorh840,...
    rulesh840, reglas_acumh840] =  Controlador2(840,"h",30);
...
graficar_variables(PresionCG840, PresionMoM840, Presionh840, ...
    "Evolución de la Presión con P(0) = 840", "Presión",21)
